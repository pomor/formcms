...
{$tid=$soft.ID}
      <!-- Programmblock klein anfang: 1x -->
            <div class="progklein">
                ...
                <div class="prbewertung"><img src="{$IMAGES_PATH}sterne4.png" width="69" height="11" alt=""> [33]</div>
                <div class="prbutton">
                    ...
                    <div class="plus"><a href="#" onclick="addToFavorite({$soft.ID},12300,this,false); return false;" class="button" title="{$catalog_lang.favorit_insert}"><img src="{$IMAGES_PATH}_neue-buttons/plus_klein_gruen.png" width="20" height="20" alt="" border="0"></a></div>
                </div>
            </div>
