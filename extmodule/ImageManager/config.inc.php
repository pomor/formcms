...
/******************* Include Formgen Permissions check **************************/
set_include_path(get_include_path().":".$_SERVER['DOCUMENT_ROOT']."/workspace/include/");

define('FG_SPACE','template1');
require_once 'conf/autoload.php';
require_once 'conf/'.FG_SPACE.'/param.php';
$actUser = FgSession::getInstance()->actUser();
if(!$actUser || !$actUser->isLogin() || !$actUser->checkPermission(array("PERM_RECHTE" => PERM_ADMIN))) die();

/******************* /Include Formgen Permissions check **************************/

#phpinfo();
#if($_SESSION['perm']<5)exit;
/**
...
*/
$IMConfig['base_dir'] = $_SERVER['DOCUMENT_ROOT'].'/content/images/';
...
*/
$IMConfig['base_url'] = '/content/images/';
