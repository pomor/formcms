...
function drawFiles($list, $manager)
{
	...
	{ ?>
		...
		<a href="javascript:;" onclick="selectImage('<?php echo $manager->config['base_url']?><?php echo $file['relative'];?>', '<?php echo $entry; ?>', <?php echo $file['image'][0];?>, <?php echo $file['image'][1]; ?>);" title="<?php echo $entry; ?> - <?php echo Files::formatSize($file['stat']['size']); ?>">
		<img src="<?php echo $manager->config['base_url']?><?php echo  $file['relative'];?>" alt="<?php echo  $entry; ?> - <?php echo  Files::formatSize($file['stat']['size']); ?>" height="96"/></a>
